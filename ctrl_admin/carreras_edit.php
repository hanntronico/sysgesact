          ...
          <div class="row">
            <div class="col-lg-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">
                  <a href="carreras.php" class="btn btn-outline-primary"><i class="mdi mdi-chevron-double-left"></i> Regresar</a>
                  </h4>
                  <h4 class="card-title" align="center">Modificacion de Datos - Carreras registradas</h4>
               
                  <?php
                      $sqlvista="SELECT * FROM carreras 
                                 WHERE estado_carrera=1 AND idcarrera=".$codigo." ORDER BY 1 DESC";
                      $rspv=$linkdocu->query($sqlvista);
                      if($rspv->num_rows>0){
                        while($rwpv=$rspv->fetch_array()){
                          $cca = $cca + 1;
                          $id = $rwpv["idcarrera"];
                          $carrera = $rwpv["carrera"];
                          $desc_carr = $rwpv["descrip_carrera"];
                          $nomcorto = $rwpv["nom_corto"];
                        }
                      }
...
?>
         ...
         <p style="color: #E10D11;font-size: 12px;"><b>Campos requeridos (*)</b></p>
          <form class="forms-sample" method="post" action="update_carrera.php" enctype="multipart/form-data">
                  <input type="hidden" name="idid" value="<?php echo $id;?>">
                      <div class="row">

                        <div class="col-md-4">
                          <div class="form-group">
                            <label for="carrera">Carrera <b style="color: #DD070B;font-size: 12px;">(*)</b></label>
                            <input type="text" name="carrera" class="form-control" placeholder="Ingrese Carrera" value="<?php echo $carrera;?>" required >
                          </div>
                        </div>
                        
                        <div class="col-md-4">
                          <div class="form-group">
                            <label for="desccarrera">Descripción <b style="color: #DD070B;font-size: 12px;">(*)</b></label>
                            <input type="text" name="descCarrera" class="form-control" placeholder="Ingrese descripción carrera" value="<?php echo $desc_carr;?>" required >
                          </div>
                        </div>

                        <div class="col-md-4">
                          <div class="form-group">
                            <label for="nomccarr">Nombre Corto <b style="color: #DD070B;font-size: 12px;">(*)</b></label>
                            <input type="text" name="nomcortocarr" class="form-control" placeholder="Ingrese nombre corto" value="<?php echo $nomcorto;?>" required >
                          </div>
                        </div>
			                </div>

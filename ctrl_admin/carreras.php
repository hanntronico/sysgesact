        ...
        if($rspv->num_rows>0){
          ...
          ?>    
            ...
            <tr>
              ...
              <td>
                <a href='carreras_edit.php?dat=<?php echo $id;?>' class='btn btn-icons btn-rounded btn-success' title='Editar'><i class='mdi mdi-pencil'></i></a>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
         <p style="color: #E10D11;font-size: 12px;"><b>Campos requeridos (*)</b></p>
          <form class="forms-sample" method="post" action="insert_carrera.php" enctype="multipart/form-data">
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="descCarrera" class="form-control" placeholder="Ingrese descripción carrera" required >
                </div>                      

                <div class="form-group">
                  <label for="nomccarr">Nombre Corto <b style="color: #DD070B;font-size: 12px;">(*)</b></label>
                  <input type="text" name="nomcortocarr" class="form-control" placeholder="Ingrese nombre corto" required >
                </div>  

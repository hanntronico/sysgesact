...
$datiduser = $_SESSION["idtrabajador"];
            ...
            <div class="col-lg-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  <h4 class="card-title" align="center">Modificacion de Datos - Controles registradas</h4>

                  <?php
                      $sqlvista="SELECT * FROM control_activ WHERE estado_ctrlact=1 AND idcontrol_activ=".$codigo." ORDER BY 1 DESC";
                      ...
                      if($rspv->num_rows>0){
                        while($rwpv=$rspv->fetch_array()){
                          ...
                          $dir_gral = $rwpv["direccion_general"];
                          $oficina = $rwpv["oficina"];
                          $dir_ofic = $rwpv["direccion_oficina"];
...
?>
         ...
         <p style="color: #E10D11;font-size: 12px;"><b>Campos requeridos (*)</b></p>
          <form class="forms-sample" method="post" action="update_control.php" enctype="multipart/form-data">
                  <input type="hidden" name="idid" value="<?php echo $id;?>">
                  <input type="hidden" name="ididuser" value="<?php echo $datiduser;?>">
                      <div class="row">
                          <div class="col-md-4">
                            <div class="form-group">
                              <label for="carrera">Oficina General <b style="color: #DD070B;font-size: 12px;">(*)</b></label>
                              <input type="text" name="ofic_general" class="form-control" placeholder="Oficina General" value="<?php echo $ofic_gral;?>" required >
                            </div>
                            <div class="form-group">
                              <label for="carrera">Dirección General <b style="color: #DD070B;font-size: 12px;">(*)</b></label>
                              <input type="text" name="dir_general" class="form-control" placeholder="Ingrese Dirección General" value="<?php echo $dir_gral;?>" required >
                            </div>                            
                          </div>
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="text" name="oficina" class="form-control" placeholder="Ingrese descripción carrera" value="<?php echo $oficina; ?>" required >
                            </div>   
                            <div class="form-group">
                              <label for="nomccarr">Dirección Oficina <b style="color: #DD070B;font-size: 12px;">(*)</b></label>
                              <input type="text" name="dir_oficina" class="form-control" placeholder="Ingrese nombre corto" value="<?php echo $dir_ofic; ?>" required >
                            </div>                               
                          </div>                    
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="date" name="fecha_ini" class="form-control" placeholder="Ingrese nombre corto" value="<?php echo $fini_ctrl; ?>" required >
                            </div>
                            <div class="form-group">
                              <label for="nomccarr">Fecha Fin <b style="color: #DD070B;font-size: 12px;">(*)</b></label>
                              <input type="date" name="fecha_fin" class="form-control" placeholder="Ingrese nombre corto" value="<?php echo $ffin_ctrl; ?>" required >
                            </div>                                
                          </div>  
                      </div>

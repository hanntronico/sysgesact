            ...
            <div class="col-lg-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  <h4 class="card-title">Instituciones Registradas</h4>
                    ...
                    <table id="dtBasicExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                      <thead>
                        <tr>
                          ...
                          <th class="th-sm">Instituciones <i class="fa fa-sort float-right" aria-hidden="true"></i></th>
...
// idinstitucion, institucion, desc_inst, estado_institu
        						  ...
        						  $sqlvista="SELECT * FROM instituciones WHERE estado_institu=1 ORDER BY 1 DESC";
        						  $rspv=$linkdocu->query($sqlvista);
                      if($rspv->num_rows>0){
                        while($rwpv=$rspv->fetch_array()){
                      	  $cca = $cca + 1;
                          $id = $rwpv["idinstitucion"];
                          $institucion = $rwpv["institucion"];
                          $desc_insti = $rwpv["desc_inst"];
            ...
            <tr>
              ...
              <td><?php echo $desc_insti; ?></td>
              <td>
                <a href='institu_edit.php?dat=<?php echo $id;?>' class='btn btn-icons btn-rounded btn-success' title='Editar'><i class='mdi mdi-pencil'></i></a>
                <a href='delete_institu.php?dat=<?php echo $id;?>' onClick='return confirmar2()'>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
         <p style="color: #E10D11;font-size: 12px;"><b>Campos requeridos (*)</b></p>
          <form class="forms-sample" method="post" action="insert_institu.php" enctype="multipart/form-data">
            <div class="row">
              <div class="col-md-12">
                      
                <div class="form-group">
                  <label for="institu">Institución <b style="color: #DD070B;font-size: 12px;">(*)</b></label>
                  <input type="text" name="institu" class="form-control" placeholder="Ingrese institución" required >
                </div>

                <div class="form-group">
                  <label for="descinstitu">Descripción <b style="color: #DD070B;font-size: 12px;">(*)</b></label>
                  <input type="text" name="descinstitu" class="form-control" placeholder="Ingrese descripción institución" required >
                </div>                      

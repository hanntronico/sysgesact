     ...
     <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
        <a class="navbar-brand brand-logo" href="dasboard.php">
          ...
          <img src="images/logo-innovateperu.png" width="126px" height="17px" alt="logo" />
        </a>
        <a class="navbar-brand brand-logo-mini" href="dasboard.php">
          <!-- <img src="images/favicon.png" width="16px" height="17px" alt="logo" /> -->
        </a>
      </div>
      <div class="navbar-menu-wrapper d-flex align-items-center" style="background-color: #C9304C">
...
<!--           <li class="nav-item dropdown">
          ...
          <li class="nav-item dropdown d-none d-xl-inline-block">
            <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
              ...
              <img class="img-xs rounded-circle" src="images/faces-clipart/pic-4.png" alt="Perfil Usuario">
            </a>

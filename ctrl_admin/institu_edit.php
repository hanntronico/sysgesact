          ...
          <div class="row">
            <div class="col-lg-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">
                  <a href="instituciones.php" class="btn btn-outline-primary"><i class="mdi mdi-chevron-double-left"></i> Regresar</a>
                  </h4>
                  <h4 class="card-title" align="center">Modificacion de Datos - Instituciones registradas</h4>
               
                  <?php
// idinstitucion, institucion, desc_inst, estado_institu

                      $sqlvista="SELECT * FROM instituciones 
                                 WHERE estado_institu=1 AND idinstitucion=".$codigo." ORDER BY 1 DESC";
...
?>
         ...
         <p style="color: #E10D11;font-size: 12px;"><b>Campos requeridos (*)</b></p>
          <form class="forms-sample" method="post" action="update_institu.php" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4">
					                <div class="form-group">
					                  ...
					                  <input type="text" name="institu" class="form-control" placeholder="Ingrese institución" value="<?php echo $institucion;?>" required >
					                </div>
                        </div>
                        ...
                        <div class="col-md-4">
					                <div class="form-group">
					                  ...
					                  <input type="text" name="descinstitu" class="form-control" placeholder="Ingrese descripción institución" value="<?php echo $desc_insti;?>" required >
					                </div>  
                        </div>

...
--
-- Servidor: localhost
-- Tiempo de generación: 11-01-2021 a las 21:06:06
...
(1, 'Analisis de la BD de sistema de tramite documentadio', 'SITRADOC', '2020-11-23 00:00:00', '0000-00-00 00:00:00', '', 0),
(2, 'Evaluar el diagrama de procesos para la integración de Sitrado', 'SITRADOC', '2020-11-23 00:00:00', '0000-00-00 00:00:00', '', 0),
(3, 'una actividad 01', 'SITRADOC', '2020-12-25 00:00:00', '2020-11-24 00:00:00', 'dasdfvc', 1),
(4, 'Segunda actividad 02', 'SITRADOC', '2020-11-04 00:00:00', '2021-01-20 00:00:00', 'fsfwhesgdshee', 1),
(5, 'Tercera actividad', 'SITRADOC', '2020-11-04 00:00:00', NULL, NULL, 0),
(6, 'Evaluar el diagrama de procesos para la integración de Sitradoc', 'DIAGRAMA DE FLUJO DE LOS SISTEMAS', '2020-12-04 00:00:00', NULL, NULL, 0),
(7, 'Analizar documentación enviada al correo', 'Correo de envío de documentación', '2020-11-04 00:00:00', '2021-01-27 00:00:00', 'asdasdas', 1),
(8, 'Primera actividad del día de hoy', 'SITRADOC', '2020-12-15 00:00:00', NULL, NULL, 0),
(9, 'Diseño de base de datos NUXEO', 'DIAGRAMA ER', '2020-12-14 00:00:00', NULL, NULL, 0),
(10, 'actividad de Moises número 01', 'BACKUP BD', '2020-12-28 00:00:00', '2020-12-28 00:00:00', 'entrego conforme', 1),
(11, 'actividad de Moisés número 02', 'Correo con captura de pantalla', '2020-12-29 00:00:00', '2020-12-29 00:00:00', 'la entrega fue conforme', 1),
(12, 'fsadf', 'asdfds', '2020-11-25 00:00:00', NULL, NULL, 0),
(13, 'sdfa', 'asdf', '2020-11-26 00:00:00', NULL, NULL, 0),
(14, 'sadf', 'sadf', '2020-11-25 00:00:00', NULL, NULL, 0),
(15, 'fasd', 'asdf', '2020-11-25 00:00:00', NULL, NULL, 0),
(16, 'fsad', 'asfd', '2020-11-26 00:00:00', NULL, NULL, 0);
...
(5, 'UTI - INNÓVATEPERÚ', 'Calle Uno Oeste N° 050 Urb. Corpac San Isidro', 'UTI', 'Oficina de TI', '2020-12-28', '2020-12-31', 3, 1);
...
(3, 'Moisés', 'Ramos', 'Gonzales', '1', '45697852', 'Ca uno nro 1011', '963852147', 'mramos@innovateperu.gob.pe'),
(4, 'MIguel', 'Muñoz', 'Diaz', '1', '78945633', 'Ca. Dos de Mayo Nro 212', '998112336', 'mmunoz@innovate.gob.pe'),
(12, 'Camilo', 'Castro', 'Diaz', '1', '77889966', NULL, '963852741', 'ccastro@gmail.com'),
(13, 'Karla', 'Salazar', 'Larios', '1', '43218765', NULL, '900800800', 'fasd@adsas');
...
(3, 'act', 'mramos', 'e10adc3949ba59abbe56e057f20f883e', 2, 1),
(4, 'act', 'mmunoz', 'c33367701511b4f6020ec61ded352059', 2, 1),
(12, 'act', 'ccastro', 'e10adc3949ba59abbe56e057f20f883e', 2, 1),
(13, 'act', 'ksalazar', '81dc9bdb52d04dc20036dbd8313ed055', 2, 0);
...
--
ALTER TABLE `control_activ`
  MODIFY `idcontrol_activ` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `control_activ`
  ADD CONSTRAINT `fk_persona_ctrl_activ` FOREIGN KEY (`idpersona`) REFERENCES `trabajadores` (`idpersona`);

--
-- Filtros para la tabla `detalle_actividades`
--
ALTER TABLE `detalle_actividades`
  ADD CONSTRAINT `fk_control_activ_actividades` FOREIGN KEY (`idactividad`) REFERENCES `actividades` (`idactividad`),
  ADD CONSTRAINT `fk_control_activ_detalle_actividades` FOREIGN KEY (`idcontrol_activ`) REFERENCES `control_activ` (`idcontrol_activ`);

--
-- Filtros para la tabla `trabajadores`
--
ALTER TABLE `trabajadores`
  ADD CONSTRAINT `fk_personas_trabajadores` FOREIGN KEY (`idpersona`) REFERENCES `personas` (`idpersona`);
COMMIT;
